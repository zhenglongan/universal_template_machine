...
#define RFID_COM_BAUDRATE_9600          0
#define RFID_COM_BAUDRATE_19200         1
#define RFID_COM_BAUDRATE_38400         2
#define RFID_COM_BAUDRATE_57600         3
#define RFID_COM_BAUDRATE_115200        4

#define RFID_COM_BAUDRATE_XXXX          RFID_COM_BAUDRATE_38400


//-------------------------------------------------------------------
//接口函数
//-------------------------------------------------------------------
extern UINT8 WriteRawRC( UINT8 Address, UINT8 value );
extern UINT8 ReadRawRC( UINT8 Address );

extern UINT8 rfid_config( void );
extern UINT8 rfid_scan( void );
//-------------------------------------------------------------------
#endif
